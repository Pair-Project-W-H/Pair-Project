  ...
  var myMusicList = [
      ...
      { name: "Bad", artist:"Ninho feat. Omah Lay", image: "https://i1.sndcdn.com/artworks-QMAHCoVFfcuq-0-t500x500.jpg", path: "../videos/Ninho - Bad feat. Omah Lay (Clip Officiel).mp3" },
      { name: "Code", artist:"Samara", image: "https://artwork.anghcdn.co/webp/?id=191253448&size=320", path: "../videos/Samara - Code  (Audio).mp3" },
      { name: "Thanks God", artist:"Travis Scott", image: "https://i.ytimg.com/vi/UVtTc4zqbxQ/maxresdefault.jpg", path: "../videos/Travis Scott - THANK GOD (Official Audio).mp3" },
      { name: "شطر عفريت", artist:"El Castro", image: "https://i.ytimg.com/vi/kaDw7ol6tTc/maxresdefault.jpg", path: "../videos/ZOMRA  King  شطر عفريت (Uncensored).mp3" },
      { name: "Carry Out", artist:"Timbaland", image: "https://i.ytimg.com/vi/hpqrHVKAZnM/maxresdefault.jpg", path: "../videos/Timbaland - Carry Out (Official Music Video) ft. Justin Timberlake.mp3" }
    ];
